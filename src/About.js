    ...
    <div>
      <Navbar/>
        ...
        <div className='row container m-4'>
          ...
          <div className="col-3 m-4">
          <img height="300px" width="250px" src="WEB DEVELOPER.jpg"/>
          </div>
          <div className="col-3 m-4">
          <img height="300px" width="250px" src="designer-work.jpg"/>
          </div>

        </div>
        <button className='btn btn-danger m-4'><a href="avijit_resume.pdf"  download style={{textdecoration:"none", color:"white"}}>Download CV</a></button>
   </div>
  )
}
