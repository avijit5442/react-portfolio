    ...
    <div className="row">
        ...
        <div className="col-md-3 col-sm-6 mt-4">
            <div className="progress yellow">
                ...
                <div className="progress-value">NodeJS</div>
            </div>
        </div>
        <div className="col-md-3 col-sm-6 mt-4">
            <div className="progress pink">
                ...
                <div className="progress-value">React Native</div>
            </div>
        </div>
...
<h5 className='text-center' style={{color:"red"}}>PROJECTS</h5>
    <h6 className="container">I did many projects,some of them are,  </h6>
      ...
      <a href="https://superhero-api-ae94c.web.app/">
        <div id="project7" className="project_box">
            <button id="watch7" className="text-danger">SuperHero</button>
        </div>
      </a>
      <a  href="https://www.mysittivacations.com/">
        <div id="project8" className="project_box">
               <button id="watch8" className="text-danger">Hotel,flight booking</button>
        </div>
      </a>
      <a download href="SHOPPING APP PROJECT.pptx">
        <div id="project9" className="project_box">
               <button id="watch8" className="text-danger">Others</button>
        </div>
      </a>

      <a href="https://www.kindlebit.com/">
        <div id="project0" className="project_box">
               <button id="watch8" className="text-danger">Web management</button>
        </div>
      </a>
  </>
  )
